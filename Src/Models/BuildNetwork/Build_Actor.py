...
class Build_Actor:
    def __init__(self, sess, build_model, action_szie, learning_rate, batch_size, tau):
        ...
        self.build_author_output, self.build_author_weights = Build_Actor.create_actor_model(self, self.build_model,
                                                                                             self.action_size)
    ...
    def create_actor_model(self, build_model, action_state):
        ...
        hidden_layer1 = Dense(16, activation='relu', kernel_initializer='random_normal')(build_model_state)
        hidden_layer2 = Dense(32, activation='relu', kernel_initializer='random_normal')(hidden_layer1)
